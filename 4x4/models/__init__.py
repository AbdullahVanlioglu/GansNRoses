...
def save_networks(G, D,iteration, idx):
    torch.save(G.state_dict(), f"./weights/G{idx+1}_trap_"+str(iteration)+".pth")
    torch.save(D.state_dict(), f"./weights/D{idx+1}_trap_"+str(iteration)+".pth")
