...
class TXT_Library():
    ...
    def __init__(self):
        ...
        target = f'/home/avsp/Masaüstü/GansNRoses/curriculum/library/library_maps.pkl'
...
def write_maps(map, index):
    ...
    with open(f"/home/avsp/Masaüstü/GansNRoses/curriculum/output/map-{index+1}.txt", "w+", encoding="latin-1") as output:
        for lne in txt_list:
