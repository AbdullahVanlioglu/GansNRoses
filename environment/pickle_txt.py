...
class TXT_Library():
    ...
    def __init__(self):
        ...
        target = f'/home/avsp/Masaüstü/GansNRoses/library/gan_generated_library200.pkl'
...
def write_maps(map, index):
    ...
    with open(f"/home/avsp/Masaüstü/GansNRoses/output/map-{index+1}.txt", "w+", encoding="latin-1") as output:
        for lne in txt_list:
