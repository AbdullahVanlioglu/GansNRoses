...
def main():
    ...
    for k in range(100):
        for i in range(10):
            ...
            vecenv = make_vec_env(lambda: QuadrotorFormation(map_type="gan", visualization=True, random_map_start=k*10+i,random_map_end=k*10+i), n_envs=1, vec_env_cls=SubprocVecEnv)
